...
type DeleteAlcoholSensor_C struct {
	useCase *use_case.Delete_AlcoholSensor
}

func NewDeleteAlcoholSensor_C(useCase *use_case.Delete_AlcoholSensor) *DeleteAlcoholSensor_C {
	return &DeleteAlcoholSensor_C{useCase: useCase}
}

func (ct *DeleteAlcoholSensor_C) Execute(ctx *gin.Context) {
	idStr := ctx.Param("id")
