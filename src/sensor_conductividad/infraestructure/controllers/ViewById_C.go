...
type GetById_ConductividtySensor_C struct {
	useCase *use_case.GetByID_ConductividtySensor
}

func NewGetById_ConductividtySensor_C(useCase *use_case.GetByID_ConductividtySensor) *GetById_ConductividtySensor_C {
	return &GetById_ConductividtySensor_C{useCase: useCase}
}
func (gh *GetById_ConductividtySensor_C) Execute(ctx *gin.Context) {
	...
	if (measurement == entities.ConductivitySensor{}) {
