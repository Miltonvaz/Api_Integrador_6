...
type DeletePhSensor_C struct {
	useCase *use_case.Delete_PhSensor
}

func NewDeletePhSensor_C(useCase *use_case.Delete_PhSensor) *DeletePhSensor_C {
	return &DeletePhSensor_C{useCase: useCase}
}

func (ct *DeletePhSensor_C) Execute(ctx *gin.Context) {
	idStr := ctx.Param("id")
