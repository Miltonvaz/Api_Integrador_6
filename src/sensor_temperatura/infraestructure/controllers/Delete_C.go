...
type DeleteTemperatureSensorr_C struct {
	useCase *use_case.Delete_TemperatureSensor
}

func NewDeleteTemperatureSensor_C(useCase *use_case.Delete_TemperatureSensor) *DeleteTemperatureSensorr_C {
	return &DeleteTemperatureSensorr_C{useCase: useCase}
}

func (ct *DeleteTemperatureSensorr_C) Execute(ctx *gin.Context) {
	idStr := ctx.Param("id")
